...
// Tag1: 0x2222 -> Anchor1: 0x1111, session 0x111111, preamble 10
static uint8_t kTagAddr[]    = {0x22, 0x22};
static uint8_t kAnchorAddr[] = {0x11, 0x11};
...
static UWBMultiSessionTag gSess(0x111111, gTagMac, gAnchorMac, 10);
...
void setup() {
  ...
  Serial.println("UWB MultiSession TAG1 STRESS starting...");
...
void loop() {
  ...
  switch (gPhase) {
    case PH_START: {
      Serial.print("\\n=== TAG1 CYCLE "); Serial.print(gCycle); Serial.println(" START ===");
      gCount = 0;
